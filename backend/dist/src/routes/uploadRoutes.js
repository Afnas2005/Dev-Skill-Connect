...
router.post("/resume", auth_1.authMiddleware, upload_1.uploadResume, uploadController_1.uploadResume);
router.post("/voice-note", auth_1.authMiddleware, upload_1.uploadVoiceNote, uploadController_1.uploadVoiceNote);
