...
const PROFILE_SELECTION = "name email bio professionalTitle location profileImage backgroundImage resumeUrl socialLinks createdAt updatedAt";
const PUBLIC_PROFILE_SELECTION = "name bio professionalTitle location profileImage backgroundImage resumeUrl socialLinks createdAt updatedAt";
...
const updateMyProfile = async (userId, payload) => {
    ...
    if (payload.resumeUrl !== undefined)
        user.resumeUrl = payload.resumeUrl;
